...
class Teams:
    ...
    environment : TeamsEnvironment
        The environment to use for requests from the client. from .environment import TeamsEnvironment



        Defaults to TeamsEnvironment.DEFAULT



    team_slug : typing.Optional[str]
        Server URL variable for 'teamSlug'. Defaults to 'teamSlug'.
    ...
    def __init__(
        ...
        *,
        ...
        environment: TeamsEnvironment = TeamsEnvironment.DEFAULT,
        team_slug: typing.Optional[str] = None,
        token: typing.Union[str, typing.Callable[[], str]],
        ...
        if team_slug is not None:
            _team_slug = team_slug if team_slug is not None else "teamSlug"
            base_url = "https://{teamSlug}.teams.auth0.com".format(teamSlug=_team_slug)
...
def _get_base_url(*, base_url: typing.Optional[str] = None, environment: TeamsEnvironment) -> str:
