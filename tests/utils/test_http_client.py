...
from auth0.teams.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    _should_retry,
...
from auth0.teams.core.request_options import RequestOptions
...
@patch("auth0.teams.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("auth0.teams.core.http_client.asyncio.sleep", new_callable=AsyncMock)
